...
def main():
    ...
    stopper = EarlyStopping(patience= args.early_patience, filename=args.dir_to_save_model + '/model.pth', metric=args.metric)
    ...
    val_loss, val_score =   test(val_loader, device, args.max_nodes, args.max_len, model, loss_fn)
    test_loss, test_score = test(test_loader, device, args.max_nodes, args.max_len, model, loss_fn) 
