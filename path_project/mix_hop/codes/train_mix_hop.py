...
def train(data_loader, num_batches, device, max_nodes, model, loss_function, optimizer):
...
@torch.no_grad()
def test(data_loader, num_batches, device, max_nodes, model, loss_function):
...
def main():
    ...
    for epoch in range(args.epochs):
        train_loss, train_score = train(train_loader, num_train_batches, device, args.max_nodes, model, loss_fn, opt)      
...
if __name__ == '__main__':
    ...
    parser.add_argument('--noise_factor', type=float, default= None, help='Level of noise to add to features.')
    ...
    parser.add_argument('-af', '--atom_featurizer', type='canonical', default = None, help='Featurization for atoms')              
    parser.add_argument('--epochs', type=int, default=1, help='Number of epochs to train.')
    parser.add_argument('--num-layers', type=int, default=None, help='Number of layers.')
    parser.add_argument('--small_hidden_dim', type=int, default= None, help='small hidden dimension')
    parser.add_argument('--max_pow', type=int, default= None, help='max power to raise adjacency matrix to.')
