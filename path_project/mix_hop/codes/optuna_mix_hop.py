...
def define_model(trial):
    model = mix_hop_model(args.num_layers, args.inp_dim, args.small_hidden_dim, args.num_classes, args.max_pow, args.dropout)
...
def objective(trial):
    ...
    if args.use_path_info == 0:
        ...
        args.max_pow =  trial.suggest_int("max_max_pow", 2, args.max_max_pow)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_max_pow', type=int, default= None, help='hidden layer(s) dimension')
    ...
    parser.add_argument('--dir_to_save_model', type=str, default= '/ibex/user/ibraheao/path_project/graphormer/model_directory', help='power dimension + 1')
