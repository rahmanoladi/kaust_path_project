...
if __name__ == '__main__':
    ...
    parser.add_argument('--repitition', type=int, default=None, help='Number of times to repeat experiment')
    ...
    parser.add_argument('--small_hidden_dim', type=int, default= None, help='small hidden dimension for attention. we multiply this by number of heads to get embedding size.')
