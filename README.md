...
python train_deeper_gcn.py  --use_gpu 1 --dataset FreeSolv --use_path_info 0 --add_noise 0 \\ 
--noise_factor 0.1 --repitition 1 --epochs 200  --num-layers 1 --hidden_dim 1140 --dropout 0.35 \\ --weight_decay 7.2362e-13  --batch-size 6  --lr 0.0283
